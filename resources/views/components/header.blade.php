<nav class="navbar d-flex align-content-between px-md-4 px-sm-2 pb-0">
    ...
    <div class="h-43 mx-auto">
        ...
        <div>
            <button class="btn bg-theme text-white h-75" >ホーム</button>
            <button class="btn bg-theme text-white h-75" >図鑑</button>
            <button class="btn bg-theme text-white h-75" >トレンド</button>
        </div>
